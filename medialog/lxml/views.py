...
class CreatePages(Scrape):
    ...
    def __call__(self):
        ...
        #    request=request,
        #)
        toadd =  ['Tom', 'Aksdal', 'Tom.Aksdal@hfk.no', 'Lærer', '325', '1STD'], ['Lill Kalleklev', 'Almås', 'Lill.Almas@hfk.no', 'Lærer', '423', '2STUSPG'], ['Janne', 'Andersen', 'Janne.Andersen@hfk.no', 'Lærer', '522', '3STUSPI'], ['Ole Kristian', 'Apelseth', '"Ole.Kristian.Apelseth@hfk.no
